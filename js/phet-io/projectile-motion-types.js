...
window.phet.preloads.phetio.phetioTypes = assert &&
  {
    ...
    "EmitterIO<NumberIO>": {
      ...
      "supertype": "ActionIO<NumberIO>",
      "typeName": "EmitterIO<NumberIO>"
    },
    ...
    "FunctionIO(NullableIO<DataPointIO>,NullableIO<NullableIO<DataPointIO>>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> NullableIO<DataPointIO>, NullableIO<NullableIO<DataPointIO>><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "NullableIO<DataPointIO>",
        "NullableIO<NullableIO<DataPointIO>>",
        "VoidIO"
      ],
      "supertype": "ObjectIO",
      "typeName": "FunctionIO(NullableIO<DataPointIO>,NullableIO<NullableIO<DataPointIO>>)=>VoidIO"
    },
    ...
    "FunctionIO(ReferenceIO<ProjectileObjectTypeIO>,NullableIO<ReferenceIO<ProjectileObjectTypeIO>>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> ReferenceIO<ProjectileObjectTypeIO>, NullableIO<ReferenceIO<ProjectileObjectTypeIO>><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "ReferenceIO<ProjectileObjectTypeIO>",
        "NullableIO<ReferenceIO<ProjectileObjectTypeIO>>",
        "VoidIO"
      ],
      "supertype": "ObjectIO",
      "typeName": "FunctionIO(ReferenceIO<ProjectileObjectTypeIO>,NullableIO<ReferenceIO<ProjectileObjectTypeIO>>)=>VoidIO"
    },
    ...
    "NullableIO<DataPointIO>": {
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<DataPointIO>"
    },
    "NullableIO<EnumerationIO(FAST|NORMAL|SLOW)>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
    ...
    "NullableIO<NullableIO<DataPointIO>>": {
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<NullableIO<DataPointIO>>"
    },
    "NullableIO<NullableIO<FocusIO>>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
    ...
    "NullableIO<ReferenceIO<ProjectileObjectTypeIO>>": {
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<ReferenceIO<ProjectileObjectTypeIO>>"
    },
    "NullableIO<SceneryEventIO>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
    ...
    "ProjectileObjectTypeIO": {
      "documentation": "A data type that stores the variables for a given object type.",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "supertype": "ObjectIO",
      "typeName": "ProjectileObjectTypeIO"
    },
    ...
    "PropertyIO<NullableIO<DataPointIO>>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
        "changed"
      ],
      ...
      "methods": {
        "getValue": {
          "documentation": "Gets the current value.",
          "parameterTypes": [],
          "returnType": "NullableIO<DataPointIO>"
        },
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": [
      ...
      "supertype": "ObjectIO",
      "typeName": "PropertyIO<NullableIO<DataPointIO>>"
    },
    ...
    "PropertyIO<ReferenceIO<ProjectileObjectTypeIO>>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
        "changed"
      ],
      ...
      "methods": {
        "getValue": {
          "documentation": "Gets the current value.",
          "parameterTypes": [],
          "returnType": "ReferenceIO<ProjectileObjectTypeIO>"
        },
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": [
      ...
      "supertype": "ObjectIO",
      "typeName": "PropertyIO<ReferenceIO<ProjectileObjectTypeIO>>"
    },
    "PropertyIO<ScreenIO>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
    ...
    "ReferenceIO<ProjectileObjectTypeIO>": {
      ...
      "supertype": "ObjectIO",
      "typeName": "ReferenceIO<ProjectileObjectTypeIO>"
    },
    "RichTextIO": {
