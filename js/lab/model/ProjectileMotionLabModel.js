...
define( function( require ) {
  ...
  var Trajectory = require( 'PROJECTILE_MOTION/lab/model/Trajectory' );
  ...
  function ProjectileMotionLabModel() {
    ...
    PropertySet.call( projectileMotionLabModel, {
    ...
    this.addTrajectory = function() {
      projectileMotionLabModel.trajectories.push( new Trajectory( this, this.cannonX, this.cannonY, this.velocity, this.angle, this.mass,
        this.diameter, this.dragCoefficient ) );
    };

    // called on when fire button is pressed
    projectileMotionLabModel.cannonFired = function() {
      projectileMotionLabModel.addTrajectory();
    };
  }

  projectileMotion.register( 'ProjectileMotionLabModel', ProjectileMotionLabModel );

  return inherit( PropertySet, ProjectileMotionLabModel, {
